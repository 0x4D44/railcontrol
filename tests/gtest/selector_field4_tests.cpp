...
TEST(Selector, NonNumericAtField4Rejected) {
  ...
  content.insert(lineEnd+1, "999, 1, 2, xx, 4, 5, 6, UF\n");
  auto tmp = WriteTemp("gtest_bad_selector_field4.rcd", content);
  EngineConfig cfg; auto repo = std::make_shared<RcdLayoutRepository>(); auto engine = CreateEngine(cfg, repo, nullptr, nullptr, nullptr, nullptr);
  LayoutDescriptor d; d.sourcePath = tmp; d.name = "badself4";
